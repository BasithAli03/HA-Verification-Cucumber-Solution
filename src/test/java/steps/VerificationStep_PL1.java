...
public class VerificationStep_PL1 extends TestBase {
	...
	VerificationPage_PL1 pl2 = new VerificationPage_PL1(driver);
	...
	public void scroll_click_till_menu_on_the_side_bar(String string) throws InterruptedException {
	...
	public void click_on_under(String subModule, String module) throws InterruptedException {
	...
	public void click_on_tab(String text) throws InterruptedException {
